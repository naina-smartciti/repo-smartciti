...
class ParkingLocationEntities: NSObject, Mappable {
    ...
    var user: User?
    var parkingPriceDetail: [ParkingPriceDetail]?
    var userType: String?
    ...
    func mapping(map: Map) {
        ...
        parkingNumber <- map["phone_number"]
        ...
        user <- map["user"]
        parkingPriceDetail <- map["parkingPriceDetails"]
